...
public class signUp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        et_mobile = findViewById(R.id.signUp_et_mobile);
        ...
        bt_signUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String email, username, password, confirmpassword, mobile;
                ...
                userR.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if (snapshot.child(username).exists()){
                            ...
                            if (!email.equals("") && !password.equals("") && !confirmpassword.equals("") && !mobile.equals("")) {
                                            ...
                                            .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                                                ...
                                                public void onComplete(@NonNull Task<AuthResult> task) {
                                                    ...
                                                    if (task.isSuccessful()) {
                                                        insertUser(username, email, password, mobile);
            ...
            public void insertUser(String username, String email, String password, String mobile) {
                ...
                String street = "";
                String district = "";
                user u = new user(email, password, firstName, lastName, mobileNumber, city, street, district, username, "zero");
